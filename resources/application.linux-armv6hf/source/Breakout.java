 ...
 */
 ...
 //Importing swing for JOptionPanes
 ...
 */
public void setup() {
   //Sets the size of the canvas to be 1000px by 500px
...
public void draw() {
  ...
  for (int i=0; i<bricks.size(); i++) { //For-loop goes through bricks arrayList.
    int c = bricks.get(i).c; //Obtains the brick's RGB value
...
abstract static class Object {
  ...
  int c; //Color of the object's fill
   ...
   */
  public static boolean collide(Object obj1, Object obj2) {
   ...
   * @return 'true' if there is a collision, 'false' if otherwise.
   */
  public static boolean collideSide(Object obj1, Object obj2) {
...
class Ball extends Object {
  ...
  public void speedUp() {
    ...
    float dv = random(1, 1.5f); //Creates a random accelation factor to the velocity
...
class Brick extends Object {
  ...
  public void settings() {  size(1110, 600); }
